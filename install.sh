...
install_XrayR() {
    ...
    file="https://github.com/lukexoxo/XrayR-release/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/lukexoxo/XrayR-release/master/XrayR.sh
